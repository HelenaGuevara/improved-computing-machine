...
#ifndef HOTSPOT
char ssid[] = "Invitados"; // replace ****** with your network SSID (name)
char pass[] = "1nv1t4d05"; // replace ****** with your network password
#else
/// Si el robot será el hotspot
char ssid[] = "osoyoo_robot2"; 
#endif
...
void loop() {
  ...
  if (packetSize) {                               
    ...
    {  
      ...
      // Moviemto del carro
      case '9':right_shift(SPEED,SPEED,SPEED,SPEED);break;
      case '10':left_shift(SPEED,SPEED,SPEED,SPEED);break;
      case '11':go_advance(SPEED);break;
      case '12':go_back(SPEED);break;
      case '13':left_turn(SPEED);break;
      case '14':right_turn(SPEED);break;
      case '15':left_back(SPEED);break;
      case '16':right_back(SPEED);break;
      case '17':clockwise(SPEED);break;
      case '18':countclockwise(SPEED);break;
      case '19':stop_Stop();break;
      default:break;
    }
  }
}
